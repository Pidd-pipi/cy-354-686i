...
const (
	...
	LogProductPriceUpdate             = "product price update: product_id=%d old_price=%.2f new_price=%.2f"
	LogProductPriceDropAlertSuccess   = "product price drop alerts created: product_id=%d alerts=%d"
	LogProductPriceDropAlertFailed    = "product price drop alerts failed: product_id=%d error=%v"
	LogFavoriteCreateSuccess          = "favorite create success: favorite_id=%d user_id=%d product_id=%d"
	LogFavoriteCreateFailed           = "favorite create failed: user_id=%d product_id=%d error=%v"
	LogFavoriteRemoveSuccess          = "favorite remove success: user_id=%d product_id=%d"
	LogPriceAlertReadSuccess          = "price alert mark read success: alert_id=%d user_id=%d"
